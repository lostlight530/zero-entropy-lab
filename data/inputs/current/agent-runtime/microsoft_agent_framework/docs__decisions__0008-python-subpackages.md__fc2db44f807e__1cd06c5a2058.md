# microsoft/agent-framework · docs/decisions/0008-python-subpackages.md
...
| 来源文件 | [docs/decisions/0008-python-subpackages.md](https://github.com/microsoft/agent-framework/blob/1cd06c5a2058a172eebadf5d9d7c3fa45c519520/docs/decisions/0008-python-subpackages.md) |
| 来源版本 | `1cd06c5a2058a172eebadf5d9d7c3fa45c519520` |
| 来源目录 Tree | `6001296b016121b81d8bfa35b172c0f0c3312cef` |
| 来源内容 Blob | `fc2db44f807e7c2467753c4f4e33ee9dd3943727` |
| 摄取时间 | `2026-09-13T23:44:25.342398+00:00` |
| 归属层 | `agent-runtime` |
| 可信度 | `1.0` |
| 记忆实体 | `doc_microsoft_agent_framework_docs_decisions_0008_python_subpackages_md_fdd5a792b262` |
...
7. Subpackage existence will be based off status of dependencies and/or possibilities of a external support mechanism. What this means is that:
    ...
    - On a case by case basis we can decide to create additional `extras`, that combine multiple subpackages into one extra, so that users that work primarily with one platform can install everything they need with a single extra, for instance you can install with the `agent-framework[azure-purview]` extra that only implements an Azure Purview Middleware, or you can install with the `agent-framework[azure]` extra that includes all Azure related connectors, like `purview`, `content safety` and others (all examples, not actual packages (yet)), regardless of where the code sits, these should always be importable from `agent_framework.azure`.
...
+++ fc2db44f807e7c2467753c4f4e33ee9dd3943727
