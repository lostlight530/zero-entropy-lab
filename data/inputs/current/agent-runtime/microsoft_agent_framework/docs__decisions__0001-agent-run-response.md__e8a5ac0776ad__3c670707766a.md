...
| 来源文件 | [docs/decisions/0001-agent-run-response.md](https://github.com/microsoft/agent-framework/blob/3c670707766a8455da6491a9049cc9d575e019f0/docs/decisions/0001-agent-run-response.md) |
| 来源版本 | `3c670707766a8455da6491a9049cc9d575e019f0` |
| 来源目录 Tree | `c84a44533c2e8383c712d6ea7a414a3d6e742d90` |
| 来源内容 Blob | `e8a5ac0776ad301c7cd368cec34e8dd1098c930a` |
| 摄取时间 | `2026-09-12T23:31:44.681234+00:00` |
| 归属层 | `agent-runtime` |
| 可信度 | `1.0` |
| 记忆实体 | `external_doc_microsoft_agent_framework_docs_decisions_0001_agent_run_response_md` |
...
+++ e8a5ac0776ad301c7cd368cec34e8dd1098c930a
