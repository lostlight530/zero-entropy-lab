# 每日简报 (Daily Brief)
> **Date**: 2026-04-22 | **Entropy**: 6.7773
...
- **Alpha** (concept_alpha): Weight 31.72
- **Beta** (concept_beta): Weight 31.72
- **bug_report.md** (file__github\ISSUE_TEMPLATE\bug_report_md): Weight 1.80
- **custom.md** (file__github\ISSUE_TEMPLATE\custom_md): Weight 1.80
- **feature_request.md** (file__github\ISSUE_TEMPLATE\feature_request_md): Weight 1.80