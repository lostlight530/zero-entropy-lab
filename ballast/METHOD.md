...
- 月度记录分别索引每日专题与特殊专题, 只保存覆盖变化与结论状态.
...
- 月度视图必须分别列出每日专题与特殊专题, 不得用特殊专题填补日报缺口.
...
日报使用 `templates/daily.md`, 特殊专题使用 `templates/special.md`, 阶段复核使用 `templates/weekly.md`, 周期整理使用 `templates/monthly.md`.
